...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserTablePage = function (_AdminBasePage) {
	    _inherits(UserTablePage, _AdminBasePage);

	    function UserTablePage() {
	        _classCallCheck(this, UserTablePage);

	        return _possibleConstructorReturn(this, (UserTablePage.__proto__ || Object.getPrototypeOf(UserTablePage)).apply(this, arguments));
	    }

	    _createClass(UserTablePage, [{
	        key: "init",
	        value: function init() {
	            var table = this;
	        ...
	        key: "perform",
	        value: function perform(url, text, username) {
	            new _dialog2.default(text + "用户", "确定要" + text + "用户 " + username + " 吗？", function () {
	                ...
	                $.ajax({
	                    ...
	                    success: function success(status) {
	                        if (status) {
	                            ...
	                            new _dialog2.default("消息", text + "用户失败").error();
	                        }
	                    },
