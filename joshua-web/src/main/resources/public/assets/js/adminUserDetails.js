...
/***/ function(module, exports, __webpack_require__) {
	...
	var AdminUserDetailsPage = function (_AdminBasePage) {
	    _inherits(AdminUserDetailsPage, _AdminBasePage);

	    function AdminUserDetailsPage() {
	        _classCallCheck(this, AdminUserDetailsPage);

	        return _possibleConstructorReturn(this, (AdminUserDetailsPage.__proto__ || Object.getPrototypeOf(AdminUserDetailsPage)).apply(this, arguments));
	    }

	    _createClass(AdminUserDetailsPage, [{
	        key: "init",
	        value: function init() {
	            var page = this;
	        ...
	        key: "addRole",
	        value: function addRole(username, role) {
	            if (role) {
	                ...
	                $.ajax({
	                    ...
	                    success: function success(status) {
	                        if (status) {
	                            ...
	                            new _dialog2.default("添加角色", "添加角色失败").error();
	                        }
	                    },
	        ...
	        key: "removeRole",
	        value: function removeRole(username, role) {
	            new _dialog2.default("移除角色", "确定要移除角色吗？", function () {
	                var formData = new FormData();
	                formData.append("username", username);
	                formData.append("role", role);
	                formData.append("_csrf", $(".ui.admin.user.form input[name='_csrf']").val());
	                ...
	                $.ajax({
	                    ...
	                    success: function success(status) {
	                        if (status) {
	                            ...
	                            new _dialog2.default("移除角色", "移除角色失败").error();
	                        }
	                    },
	                    error: function error() {
	                        new _dialog2.default("移除角色", "移除角色失败").error();
	...
	exports.default = AdminUserDetailsPage;
