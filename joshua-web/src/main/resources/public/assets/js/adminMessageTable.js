...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageTablePage = function (_AdminBasePage) {
	    _inherits(MessageTablePage, _AdminBasePage);

	    function MessageTablePage() {
	        _classCallCheck(this, MessageTablePage);

	        return _possibleConstructorReturn(this, (MessageTablePage.__proto__ || Object.getPrototypeOf(MessageTablePage)).apply(this, arguments));
	    }

	    _createClass(MessageTablePage, [{
	        key: "init",
	        value: function init() {
	            var table = this;
	            ...
	            $.ajax({
	                ...
	                success: function success(status) {
	                    if ("success" == status) {
	                        ...
	                        new _dialog2.default("操作失败", "操作失败，原因：" + status, function () {}).error();
	                    }
	                },
	                error: function error() {
	                    new _dialog2.default("操作失败", "操作失败", function () {}).error();
	                }
	            });
	        }
	    }, {
	        key: "asUnRead",
	        value: function asUnRead(id) {
	            var formData = new FormData();
	            formData.append("_csrf", $(".ui.admin.user.form input[name='_csrf']").val());
	            formData.append("id", id);
	...
	exports.default = MessageTablePage;
