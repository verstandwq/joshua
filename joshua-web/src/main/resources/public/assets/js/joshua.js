...
var _dialog = require("./modules/dialog");
...
(0, _jquery2.default)(".item.popup").popup({
  on: "click",
...
},{"../semantic/semantic.min":3,"./modules/dialog":5,"jquery":1,"js-cookie":2}],5:[function(require,module,exports){
/**
 * Dialog Utils
...
var Dialog = function () {
    function Dialog(title, content, onApprove, onDeny) {
        _classCallCheck(this, Dialog);

        this.type = "m";
        this.title = title || "消息";
        this.content = content || "内容内容";
