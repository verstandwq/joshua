...
/***/ function(module, exports, __webpack_require__) {
	...
	var _joshuaAdminBasePage = __webpack_require__(1);

	var _joshuaAdminBasePage2 = _interopRequireDefault(_joshuaAdminBasePage);
	...
	var AdminStaticHomePage = function (_AdminBasePage) {
	    _inherits(AdminStaticHomePage, _AdminBasePage);

	    function AdminStaticHomePage() {
	        _classCallCheck(this, AdminStaticHomePage);

	        return _possibleConstructorReturn(this, (AdminStaticHomePage.__proto__ || Object.getPrototypeOf(AdminStaticHomePage)).apply(this, arguments));
	    }

	    _createClass(AdminStaticHomePage, [{
	        key: "init",
	        value: function init() {
	            ...
	            $(".joshua.cover.input").on("change", function (e) {
	                ...
	                if (!imageType.test(file.type)) {
	                    new _dialog2.default("选择封面", "请选择正确的图片").warning();
	                    return;
	                }
	                ...
	                if (window.FileReader) {
	                    ...
	                    new _dialog2.default("选择封面", "您的设部不支持该功能").error();
	                }
	            });
	            ...
	            $(".ui.add.slide.picture.button").on("click", function () {
	                ...
	                if (!link) {
	                    new _dialog2.default("添加大图", "请输入大图链接").message();
	                    ...
	                    $.ajax({
	                        ...
	                        success: function success(status) {
	                            if (status == "success") {
	                                ...
	                                new _dialog2.default("上传大图", "上传大图失败，原因：" + status, function () {}).error();
	                            }
	                        },
	                        error: function error() {
	                            new _dialog2.default("上传大图", "上传大图失败", function () {}).error();
	                        }
	                    });
	                } else {
	                    new _dialog2.default("上传大图", "请选择要上传的图片").message();
	                }
	            });
	                ...
	                $.ajax({
	                    ...
	                    success: function success(status) {
	                        if (status == "success") {
	                            ...
	                            new _dialog2.default("删除大图", "删除大图失败，原因：" + status, function () {}).error();
	                        }
	                    },
	                    error: function error() {
	                        new _dialog2.default("删除大图", "删除大图失败", function () {}).error();
	                    }
	                });
	            });
	    ...
	    return AdminStaticHomePage;
	}(_joshuaAdminBasePage2.default);

	exports.default = AdminStaticHomePage;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _adminNavigation = __webpack_require__(5);
	...
	var AdminBasePage = function AdminBasePage() {
	    _classCallCheck(this, AdminBasePage);

	    new _adminNavigation2.default();
	};

	exports.default = AdminBasePage;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navigation = function () {
	    ...
	    _createClass(Navigation, [{
	        key: "getNavigationIndex",
	        value: function getNavigationIndex() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! lightgallery - v1.3.5 - 2016-09-30
